...
async function environment(t) {
  const names = ["META_WEBHOOK_VERIFY_TOKEN", "META_APP_SECRET", "META_PAGE_ACCESS_TOKEN", "CONVERSATION_HMAC_SECRET", "UPSTASH_REDIS_REST_URL", "UPSTASH_REDIS_REST_TOKEN"];
  const old = Object.fromEntries(names.map(name => [name, process.env[name]]));
  Object.assign(process.env, { META_WEBHOOK_VERIFY_TOKEN: "verify-secret", META_APP_SECRET: "app-secret", META_PAGE_ACCESS_TOKEN: "page-token", CONVERSATION_HMAC_SECRET: "identity-secret", UPSTASH_REDIS_REST_URL: "https://redis.invalid", UPSTASH_REDIS_REST_TOKEN: "redis-token" });
